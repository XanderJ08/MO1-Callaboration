...
# printing out the information in a formatted way
print(f"\nVehicle type: {vehicle_type}")
print(f"Year: {year_made}")
print(f"Make: {car_make}")
print(f"Model: {car_model}")
print(f"Number of doors: {door_number}")
print(f"Type of roof: {roof_type}")

#putting the information back into the automobile class
instance = Automobile(vehicle_type, year_made, car_make, car_model, door_number, roof_type)
